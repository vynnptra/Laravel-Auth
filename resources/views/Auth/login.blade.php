...
<form action="{{ route('login') }}" method="POST">
    ...
    <div class="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
        ...
        <div class="flex justify-center gap-5 w-full ">
            ...
            <a href="{{ route('login.google') }}" class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-300 text-sm text-gray-500 hover:text-gray-100 p-3  rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500">
            ...
            <button type="submit" class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-300 text-sm text-gray-500 p-3 hover:text-gray-100   rounded-lg tracking-wide font-medium  cursor-pointer transition ease-in duration-500 px-">
